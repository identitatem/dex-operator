...
# identitatem.io/dex-operator-bundle:$VERSION and identitatem.io/dex-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= identitatem.io/dex-operator
...
build: generate fmt vet check-copyright ## Build manager binary.
...
kustomize: ## Download kustomize locally if necessary.
	test -s $(shell pwd)/bin/kustomize || { curl -s $(KUSTOMIZE_INSTALL_SCRIPT) | bash -s -- $(subst v,,$(KUSTOMIZE_VERSION)) $(shell pwd)/bin; }
